<div style="position:fixed; inset:0; z-index:9999; background:rgba(0,0,0,0.82); display:flex; align-items:center; justify-content:center; padding:16px;">
    <div style="width:100%; max-width:520px; max-height:90vh; overflow-y:auto; border-radius:20px; background:#fff; box-shadow:0 20px 60px rgba(0,0,0,.4);">
        ...
        <div class="p-4">
            ...
            {{-- Telefono --}}
            <div class="mb-3">
                <label class="form-label fw-semibold text-muted">Telefono <span class="text-muted fw-normal">(Opcional)</span></label>
                <input type="text"
            ...
            {{-- Direccion --}}
            <div class="mb-3">
                <label class="form-label fw-semibold text-muted">Direccion <span class="text-muted fw-normal">(Opcional)</span></label>
                <input type="text"
