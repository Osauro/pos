<div>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mostrarFiltro): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($turno_seleccionado): ?>
                                        ...
                                        ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($turnoFiltro): ?>
                                            <button class="btn btn-danger" wire:click="limpiarFiltroFechas" title="Limpiar filtro">
                                                Turno: <?php echo e(\Carbon\Carbon::parse($turnoFiltro->fecha_inicio)->format('d/m')); ?> - <?php echo e(\Carbon\Carbon::parse($turnoFiltro->fecha_fin)->format('d/m')); ?>
                                ...
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->tipo === 'admin'): ?>
                                    ...
                                    <div class="card-body py-3 text-white">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 class="mb-0 fw-bold">Bs. <?php echo e(number_format($totalIngresos, 2)); ?></h3>
                                            </div>
                                    ...
                                    <div class="card-body py-3 text-white">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 class="mb-0 fw-bold">Bs. <?php echo e(number_format($totalEgresos, 2)); ?></h3>
                                            </div>
                                            <div class="bg-white bg-opacity-25 rounded-circle p-3">
                                    ...
                                    <div class="card-body py-3 text-white">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 class="mb-0 fw-bold">Bs. <?php echo e(number_format($saldoActual, 2)); ?></h3>
                                            </div>
                                            <div class="bg-white bg-opacity-25 rounded-circle p-3">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $movimientos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movimiento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                        <tr>
                                            <td class="text-center text-truncate">
                                                <div class="fw-semibold"><?php echo e($movimiento->created_at->format('d/m/Y')); ?>

                                                </div>
                                                <small
                                                    class="text-muted"><?php echo e($movimiento->created_at->format('H:i')); ?></small>
                                            </td>
                                            <td class="text-truncate">
                                                <small class="text-muted d-block"><?php echo e($movimiento->turno->encargado->nombre ?? 'N/A'); ?></small>
                                                <span><?php echo e($movimiento->detalle); ?></span>
                                            </td>
                                            <td class="text-end text-truncate">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($movimiento->ingreso > 0): ?>
                                                    <span class="text-success fw-semibold">
                                                        + Bs. <?php echo e(number_format($movimiento->ingreso, 2)); ?>

                                                    </span>
                                                <?php else: ?>
                                                    <span class="text-danger fw-semibold">
                                                        - Bs. <?php echo e(number_format($movimiento->egreso, 2)); ?>
                                            ...
                                            <td class="text-end text-truncate">
                                                <span class="fw-bold">Bs.
                                                    <?php echo e(number_format($movimiento->saldo, 2)); ?></span>
                                            </td>
                                        </tr>
    ...
    <?php echo $__env->make('partials.paginate-bar', ['results' => $movimientos, 'storageKey' => 'movimientos'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="save">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?php $__errorArgs = ['detalle'];
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['detalle'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01"
                                    class="form-control <?php $__errorArgs = ['monto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" wire:model="monto"
                                    placeholder="0.00">
...
<?php /**PATH C:\laragon\www\tpv\resources\views/livewire/movimientos.blade.php ENDPATH**/ ?>