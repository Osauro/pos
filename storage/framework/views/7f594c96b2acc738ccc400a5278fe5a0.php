...
<head>
    ...
    <title><?php echo e(config('app.name', 'TPV')); ?> - Login</title>
        ...
        <div class="auth-card">
            <div class="auth-logo-section">
                <div class="auth-logo-content">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(file_exists(public_path('assets/images/logo.png'))): ?>
...
<?php /**PATH C:\laragon\www\tpv\resources\views/layouts/guest.blade.php ENDPATH**/ ?>